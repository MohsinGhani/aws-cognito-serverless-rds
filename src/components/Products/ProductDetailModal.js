          ...
          <AppBar className={classes.appBar}>
            <Toolbar style={{ padding: 0 }}>
              <div className="product-modal-header">
                ...
                <div>
                  <h4
                    style={{ margin: 0, padding: "20px 0", cursor: "pointer" }}
                    onClick={() => {
                      handleDetailDialog(null);
                  ...
                  <div>
                    <CardContent>
                      ...
                      <Typography gutterBottom component="h5">
                        Posted By :{" "}
                        <span style={{ fontWeigth: "bold" }}>
                          {product._creator
                            ? `${product._creator.firstname} ${product._creator.lastname}`
                            : "Name not Found"}{" "}
                        </span>
                      </Typography>
                    </CardContent>
                          ...
                          if (!liked) {
                            return (
                              <img
                                ...
                                onClick={this.handleActionPopoverClick}
                    ...
                    >
                      <List className={classes.fullList}>
                        ...
                        >
                          ...
                          <span className="comment-text">
                            Like{" "}
                            <span className="text-badge">{product._like}</span>
                          </span>
                        </ListItem>
                        <ListItem
                          button
...
const mapDispatchToProps = dispatch => {
  return {
    getProductByIdAction: payload =>
      dispatch(ProductAction.getProductById(payload)),
    likeProductAction: payload => dispatch(ProductAction.likeProduct(payload)),
    actionOnCommentAction: payload =>
      dispatch(ProductAction.actionOnComment(payload))
  };
};

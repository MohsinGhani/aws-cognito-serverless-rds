        ...
        <div className="profile-container">
          {user &&
            <div className="profile-info">
              <p className="profile-info-heading">Profile Description</p>
              <div className="profile-info-body">
                ...
                <div className="profile-btn-group">
                  ...
                  <button className="rmv-image-button" onClick={this.handleRemoveImagePopup} >Remove Image</button>
                </div>
              </div>
            </div>}
          <hr className="hr" />
          <div className="profile-my-product">
            <p className="my-products-heading">My Products</p>
            <div>
              <ProductDetailModal

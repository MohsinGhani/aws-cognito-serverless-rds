      ...
      <div className="Bookmark">
        ...
        <div className="privacy-content">
          ...
          <div className="headline">
            <div className="headline__title">Bookmark on Productmania</div>
            <div className="headline__content">
              <p>
                ...
                through the use of a technology called “cookies.” We use cookies
                for all kinds of things on Productmania.
              </p>
            </div>
          </div>
          <div className="headline">
            <h2 className="subhead-list__subhead">What’s a Bookmark?</h2>
            <div className="headline__content">
              <p>
                In real life, it’s a delicious baked good. You can find lots of
                delicious Bookmark recipes on Productmania.
              </p>
              <p>
                But in technology, a Bookmark is something completely different.
                When you go online, you use a program called a “browser” (like
                Apple’s Safari or Google’s Chrome). Most websites store a small
                amount of text in the browser—and that text is called a
                “cookie.”
              </p>
            </div>
          </div>
          <div className="headline">
            ...
            <div className="headline__content">
              <p>
                We use cookies for lots of essential things on Productmania—like
                helping you log in and tailoring your Productmania experience.
              ...
              <ul>
                <li>
                  ...
                  Productmania, Bookmark data and device data. If you’d like,
                  you can{" "}
                </li>
                <li>

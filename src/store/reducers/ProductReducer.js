...
const initialState = {
  ...
  actionComment: null,
  doActionCommentLoader: false,
  doActionCommentError: null
};
  ...
  switch (action.type) {
    ...
    case ACTION_ON_COMMENT:
      return {
        ...state,
        actionComment: null,
        doActionCommentLoader: true,
        doActionCommentError: null
      };

    case ACTION_ON_COMMENT_SUCCESS:
      return {
        ...state,
    ...
    case ACTION_ON_COMMENT_FAILURE:
      return {
        ...state,
        actionComment: null,
        doActionCommentLoader: false,
        doActionCommentError: action.error
      };
